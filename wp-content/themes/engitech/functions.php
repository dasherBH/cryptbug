...
function engitech_fonts_url() {
	...
	if ( 'off' !== _x( 'on', 'Montserrat font: on or off', 'engitech' ) ) {
	...
	if ( 'off' !== _x( 'on', 'Nunito Sans font: on or off', 'engitech' ) ) {
...
function engitech_scripts() {
    ...
    wp_enqueue_script( 'instafeed', get_template_directory_uri() . '/js/instafeed.min.js', array( 'jquery' ), '20180910', true );
