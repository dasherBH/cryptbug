...
class Engitech_Image_Carousel extends Widget_Base{
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'align',
			[
				'label' => __( 'Vertical Align', 'engitech' ),
		...
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
					'{{WRAPPER}} .octf-swiper-pagination .swiper-pagination-bullet' => 'background: {{VALUE}};',
				],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
					'{{WRAPPER}} .octf-swiper-pagination .swiper-pagination-bullet-active' => 'background: {{VALUE}};',
				],
            ]
        );
